...
export default function About() {
    ...
    return (
        <section id="about" className="scroll-mt-24 grid md:grid-cols-2 gap-20 items-stretch">
            ...
            <PopIn delay={0.2}>
                <div className="lg:min-w-[600px] lg:min-h-[700px] bg-purple-500/10 backdrop-blur-md border border-white/5 rounded-2xl p-4 hover:shadow-[0_0_25px_rgba(255,255,255,0.1),0_0_80px_rgba(255,255,255,0.15)] transition-shadow duration-300">
